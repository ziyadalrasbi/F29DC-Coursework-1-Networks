...
proc finish {} {
	...
	#Execute nam on the trace file
        exec nam -k 5409 Q2-2nosplit.nam &
        exit 0
}
...
#Nested looping for mesh topology to connect each node together
...
set tcp1 [$ns create-connection TCP $n(48) TCPSink $n(4) 1]
 $tcp1 set class_ 1
...
set tcp2 [$ns create-connection TCP $n(49) TCPSink $n(5) 1]
 $tcp2 set class_ 1
...
set tcp3 [$ns create-connection TCP $n(40) TCPSink $n(30) 1]
 $tcp3 set class_ 1
...
set tcp4 [$ns create-connection TCP $n(38) TCPSink $n(14) 1]
 $tcp4 set class_ 1
...
set tcp5 [$ns create-connection TCP $n(31) TCPSink $n(11) 1]
 $tcp5 set class_ 1
...
$ns attach-agent $n(20) $p0
set p1 [new Agent/Ping]
$ns attach-agent $n(42) $p1
